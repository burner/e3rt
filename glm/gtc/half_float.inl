...
inline thalf tvec2<thalf>::operator[](tvec2<thalf>::size_type i) const
{
	assert( i >= tvec2<thalf>::size_type(0) && 
			i < tvec2<thalf>::value_size());
	return (&x)[i];
...
inline tvec2<thalf>& tvec2<half>::operator-=(thalf s)
{
	this->x -= s;
	this->y -= s;
	return *this;
...
inline thalf tvec3<thalf>::operator[](tvec3<thalf>::size_type i) const
{
	assert( i >= tvec3<thalf>::size_type(0) && 
			i < tvec3<thalf>::value_size());
...
inline thalf tvec4<thalf>::operator[](tvec4<thalf>::size_type i) const
{
	assert( i >= tvec4<thalf>::size_type(0) && 
			i < tvec4<thalf>::value_size());
